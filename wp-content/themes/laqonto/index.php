    ...
    <div class="swiper slider">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="slider-box">
            <div class="slider-box__content">
              <p><?php _e("LAQONTO je izvrstan izbor za vođenje mojih knjiga. Pouzdani su, vrlo temeljiti i uvijek odrade sve na vrijeme. Zahvaljujući njihovoj podršci, mogu mirno raditi svoj posao znajući da se o svim administrativnim obvezama netko kvalitetno brine. Svakako preporučujem suradnju!", "laqonto"); ?></p>
              <p class="text-3xl text-primary font-display leading-none mb-2 mt-7"><?php _e("Neno Mikulić", "laqonto"); ?></p>
              <p><?php _e("Akademski slikar, kipar i karikaturist", "laqonto"); ?></p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
        ...
        <div class="swiper-slide">
          <div class="slider-box">
            <div class="slider-box__content">
              <p><?php _e("Njihov klijent sam već 15 godina i mogu napisati samo riječi hvale. Nikada nisam imao problema, sve obavljaju brzo i bez greške. Moja topla preporuka!", "laqonto"); ?></p>
              <p class="text-3xl text-primary font-display leading-none mb-2 mt-7"><?php _e("Konoba Veza", "laqonto"); ?></p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
