    ...
    <div class="site-footer<?php echo has_hero_cta() ? ' site-footer--has-hero-cta' : ''; ?>">
      <div class="grid">
        <div class="col-span-12 lg:col-span-9 order-1">
          <p class="site-footer__title"><?php _e("Povežimo se", "laqonto"); ?></p>
        </div>
        ...
        <div class="col-span-12 lg:col-span-4 lg:mb-35 order-5">
          <p class="mb-5"><?php _e("Jednostavno knjigovodstvo za novu generaciju poduzetnika.", "laqonto"); ?></p>
          <p class="hidden lg:block"><?php _e("Sva prava pridržana Ured Vuletić j.d.o.o.", "laqonto"); ?> &copy; <?php echo date( "Y" ); ?>.</p>
        </div>
        ...
        <div class="col-span-12 lg:col-span-4 mb-13 lg:mb-9 order-6 lg:order-7">
          <nav>
            <ul>
              <li>
                <a href="<?php echo ICL_LANGUAGE_CODE === 'en' ? '/en/privacy-policy' : '/politika-privatnosti'; ?>" class="link-underlined"><?php _e("Politika privatnosti", "laqonto"); ?></a>
              </li>
            </ul>
          </nav>
        </div>
        <div class="col-span-12 lg:hidden order-8">
          <p><?php _e("Sva prava pridržana Ured Vuletić j.d.o.o.", "laqonto"); ?> &copy; <?php echo date( "Y" ); ?>.</p>
        </div>
