    ...
    <div class="site-footer">
      <div class="grid">
        ...
        <div class="col-span-3">
          <ul class="list-arrow text-white mt-9">
        ...
        <div class="col-span-12 mt-68">
          <hr class="divider divider--orange-700 divider--thick" />
        </div>
        <div class="col-span-12 text-white mt-7 mb-7">
        ...
        <div class="col-span-3 col-start-10 mb-35">
        ...
        <div class="col-span-3 col-start-10 mb-9">
          <p>Designed by <a href="https://beta-and.co/" target="_blank">Beta&Co</a>.</p>
        </div>
      </div>
    </div>
