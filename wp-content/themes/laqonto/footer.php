    ...
    <div class="site-footer<?php echo is_singular() ? ' site-footer--has-hero-cta' : ''; ?>">
      <div class="grid">
        ...
        <div class="col-span-12 lg:col-span-4 lg:mb-35 order-5">
          <p class="mb-6">Jednostavno knjigovodstvo za novu generaciju poduzetnika.</p>
          <p class="hidden lg:block">All rights reserved K.U. Vuletić &copy; <?php echo date( "Y" ); ?>.</p>
        </div>
        <div class="col-span-12 lg:col-span-3 lg:col-start-10 mb-12 lg:mb-35 order-7 lg:order-6">
          <p>Knjigovodstveni ured Vuletić d.o.o. <br />Ante Starčevića 32, Makarska <br />OIB: 20510662888 <br />MB: 90611241</p>
        </div>
        ...
        <div class="col-span-12 lg:hidden order-8">
          <p>All rights reserved K.U. Vuletić &copy; <?php echo date( "Y" ); ?>.</p>
        </div>
